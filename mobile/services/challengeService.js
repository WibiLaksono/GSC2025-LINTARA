...
export const getChallengeById = async (challengeId) => {
    try {
        const response = await axios.get(`${BASE_URL}/challenges/getChallenge/${challengeId}`);
        return response.data;
    } catch (error) {
...
export const createChallenge = async (challengeData) => {
    try {
        ...
        const response = await axios.post(`${BASE_URL}/challenges/createChallenge`, requestData);
        return response.data;
    } catch (error) {
...
export const updateChallenge = async (challengeId, updatedData) => {
    try {
        const response = await axios.put(`${BASE_URL}/challenges/updateChallenge/${challengeId}`, updatedData);
        return response.data;
    } catch (error) {
...
export const deleteChallenge = async (challengeId) => {
    try {
        const response = await axios.delete(`${BASE_URL}/challenges/deleteChallenge/${challengeId}`);
        return response.data;
    } catch (error) {
...
export const getChallengeParticipants = async (challengeId) => {
    try {
        const response = await axios.get(`${BASE_URL}/challenges/historical/${challengeId}/participants`);
...
export const hasUserJoinedChallenge = async (challengeId) => {
    try {
        ...
        const userHasJoined = participants.some(participant => participant.UserID === uid);
...
export const joinChallenge = async (challengeId) => {
    try {
        const uid = await getStoredUid();
        const response = await axios.post(`${BASE_URL}/challenges/historical/join`, {
